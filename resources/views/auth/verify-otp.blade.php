...
<html dir="{{ $site_direction }}" lang="{{ $locale }}" class="{{ $site_direction === 'rtl'?'active':'' }}">
    ...
    @endphp
    <!-- Title -->
    <title>{{ translate('messages.Verify_otp') }} | {{$app_name??translate('atbrakitchen')}}</title>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between">
        ...
        <div class="auth-wrapper">
            <div class="auth-wrapper-body auth-form-appear">
                ...
                <!-- Form -->
                <div class="text-center">
                    <img class="mb-4" src="{{dynamicAsset('/public/assets/admin/img/lock.svg')}}" alt="">
                    <div class="mb-2">
                ...
                <div class="d-flex justify-content-between mt-2">
                    <span>{{ translate('Didn’t_receive_the_code?') }}</span>
