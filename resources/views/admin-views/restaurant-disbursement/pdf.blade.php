            ...
            <tr>
                ...
                <td class="text-right">
                    <div class="right text-right">
                        <div class="logo">
                            <img style="width: 160px;object-fit: contain;object-position: right center" src="{{ dynamicStorage('storage/app/public/business/' . $logo ?? '') }}" alt="logo">
                        </div>
                        <div>{{ $address }}</div>
                    </div>
                </td>
        ...
        <div class="invoice-body-bottom" style="padding: 9px 12px;">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="name mt-10px">{{ $disb->restaurant->name }}</div>
                    </td>
                    <td>
                        <div class="name">{{$disb?->withdraw_method?->method_name ?? translate('Default_method')}}</div>
...
{{--                    text-decoration: none;" href="www.atbrakitchen.inc">www.atbrakitchen.inc</a>--}}
{{--                        </td>--}}
{{--                        <td style="text-align:center">--}}
{{--                            <a style=" color: #000000; text-align:center;--}}
