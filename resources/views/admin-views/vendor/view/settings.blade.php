@php use App\Models\BusinessSetting;  use App\CentralLogics\Helpers; @endphp
                    ...
                    <div class="row g-2 mt-4">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="input-label text-capitalize">{{ translate('Restaurant') }}
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="resturant-type-group {{ Helpers::get_business_settings('can_restaurant_edit_order') == 1  ? '' : 'disabled' }}  border">
                                    <label class="form-check form--check mr-2 mr-md-4">
                                        <input class="form-check-input" type="radio" name="can_edit_order" id="can_edit_order"
                                               {{$restaurant?->restaurant_config?->can_edit_order == 1 ? 'checked' : ''}} value="1">
                                        <span class="form-check-label">
                                    ...
                                    <label class="form-check form--check mr-2 mr-md-4">
                                        <input class="form-check-input" type="radio" name="can_edit_order" id="can_edit_order"
                                               {{$restaurant?->restaurant_config?->can_edit_order == 0 ? 'checked' : ''}} value="0">
                                        <span class="form-check-label">
