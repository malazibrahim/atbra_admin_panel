            ...
            <div class="card-body">
                <form action="{{ route('admin.react_landing_page.settings', 'react-download-apps-banner-image') }}" enctype="multipart/form-data"     method="post">
                    ...
                    <label class="form-label d-block mb-2">
                        {{ translate('Banner_Image') }} <span class="text--primary">({{ translate('1500x300') }})</span>
                    </label>
                        ...
                        <div class="row g-3 mt-3">
                            <div class="col-md-6">
                                <h5 class="card-title mb-3">
                                    <img src="http://localhost/atbrakitchen/public/assets/admin/img/andriod.png" class="mr-2" alt="">
                            ...
                            <div class="col-md-6">
                                <h5 class="card-title mb-3">
                                    <img src="http://localhost/atbrakitchen/public/assets/admin/img/apple.png" class="mr-2" alt="">
