...
class ConfigController extends Controller
{
    ...
    public static function get_settings_data($name)
    {
        $data = Cache::rememberForever('data_settings_' . $name, function () use ($name) {
            return DataSetting::where(['key' => $name])->first()?->value;
        });
