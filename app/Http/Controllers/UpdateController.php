...
class UpdateController extends Controller
{
    ...
    public function update_software(Request $request)
    {
        ...
        Helpers::setEnvironmentValue('SOFTWARE_VERSION','8.4');
        Helpers::setEnvironmentValue('APP_NAME','atbrakitchen'.time());
        ...
        Helpers::insert_business_settings_key('landing_page_text','{"header_title_1":"Food App","header_title_2":"Why stay hungry when you can order from atbrakitchen","header_title_3":"Get 10% OFF on your first order","about_title":"atbrakitchen is Best Delivery Service Near You","why_choose_us":"Why Choose Us?","why_choose_us_title":"Lorem ipsum dolor sit amet, consectetur adipiscing elit.","testimonial_title":"Trusted by Customer & Restaurant Owner","footer_article":"Suspendisse ultrices at diam lectus nullam. Nisl, sagittis viverra enim erat tortor ultricies massa turpis. Arcu pulvinar."}');
        ...
        try {
           // 7.0
            ...
            if (!Schema::hasTable('addon_settings')) {
                ...
                Coupon::where('coupon_type', 'restaurant_wise')
                ->whereNull('restaurant_id')
                ->update([
                    'restaurant_id' => DB::raw("JSON_UNQUOTE(JSON_EXTRACT(data, '$[0]'))")
                ]);
